/* ========= Product/Allladies_products.jsx ========= */

import React, { useState, useEffect, useRef } from 'react';
import './Allladies_products.css';
import { products } from './productData';

function Allladies_products({ addToCart, category, searchQuery }) {
  ...
  const filteredProducts = (category === 'all' 
    ? products.women 
    : products.women.filter(product => product.category === category)
  ).filter(product => 
...
export default Allladies_products;